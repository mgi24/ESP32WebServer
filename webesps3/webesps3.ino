...
const char private_key[] = "iKeT7u+k0i7E3hBTDq1/o64jTqb/OFj+EkvphjnP0mQ=";   // Private key of the local interface
...
const char preshared_key[] = "dFO6fUxo7AakIJ0M81OBGB+BUV6KLLOoYWF150Od4Ds="; // Pre-Shared Key
